...
- `available_water_content_mm = soil_water_content_mm - soil_wilting_point_capacity_water_mm`;
- `available_water_fraction_pct = available_water_content_mm / (soil_field_capacity_water_mm - soil_wilting_point_capacity_water_mm) * 100`;
