...
export const KORNIX_METRICS: KornixMetricDefinition[] = [
  ...
  metric({ long_name_for_code: 'precipitation_effective_daily_mm', label: 'Эффективные осадки', unit: 'мм/сутки', valueKind: 'scalar', chartKind: 'bar', group: 'weather', isDefaultVisible: true }),
  ...
  metric({ long_name_for_code: 'irrigation_effective_daily_mm', label: 'Эффективный полив', unit: 'мм/сутки', valueKind: 'scalar', chartKind: 'bar', group: 'irrigation', isDefaultVisible: true }),
  metric({ long_name_for_code: 'soil_total_capacity_water_mm', label: 'Полная влагоёмкость', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: false }),
  metric({ long_name_for_code: 'soil_field_capacity_water_mm', label: 'НВ', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: false }),
  metric({ long_name_for_code: 'soil_wilting_point_capacity_water_mm', label: 'ВЗ', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: false }),
  metric({ long_name_for_code: 'soil_water_content_mm', label: 'Влагозапасы', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: false }),
  metric({ long_name_for_code: 'soil_water_start_mm', label: 'Вода в почве на начало дня', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: false }),
  metric({ long_name_for_code: 'soil_water_end_mm', label: 'Вода в почве на конец дня', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: true }),
  metric({ long_name_for_code: 'soil_water_available_mm', label: 'Доступная вода', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: true }),
  metric({ long_name_for_code: 'soil_water_available_pct_taw', label: 'Доступная вода от TAW', unit: '%', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: true }),
  metric({ long_name_for_code: 'soil_water_depletion_mm', label: 'Дефицит воды', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: true }),
  metric({ long_name_for_code: 'soil_water_depletion_pct_taw', label: 'Дефицит от TAW', unit: '%', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: false }),
  metric({ long_name_for_code: 'soil_water_productive_mm', label: 'Продуктивная вода', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: false }),
  metric({ long_name_for_code: 'total_available_water_mm', label: 'TAW', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: true }),
  metric({ long_name_for_code: 'readily_available_water_mm', label: 'RAW', unit: 'мм', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: true }),
  metric({ long_name_for_code: 'root_zone_depth_m', label: 'Глубина корневой зоны', unit: 'м', valueKind: 'scalar', chartKind: 'line', group: 'soil_water', isDefaultVisible: true }),
  ...
  metric({ long_name_for_code: 'crop_transpiration_daily_mm', label: 'Транспирация культуры', unit: 'мм/сутки', valueKind: 'scalar', chartKind: 'line', group: 'plant', isDefaultVisible: false }),
